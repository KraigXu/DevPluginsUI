...
#define LOCTEXT_NAMESPACE "AITestSuite_MetaStoryTestWeakContext"
...
struct FMetaStoryTest_WeakContext_FinishTask : FMetaStoryTestBase
{
	...
	virtual bool InstantTest() override
	{
		...
		// Building up the MetaStory
		UMetaStory& MetaStory1 = NewMetaStory();
		{
			UMetaStoryEditorData& EditorData1 = *Cast<UMetaStoryEditorData>(MetaStory1.EditorData);
			{
				// Global Task
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1GlobalTask = EditorData1.AddGlobalTask<FTestTask_PrintValue>(FName(TEXT("Tree1GlobalTask")));
				{
				...
				{
					TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1RootTask = Root.AddTask<FTestTask_PrintValue>(FName(TEXT("Tree1RootTask")));
				...
				{
					TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1State1Task = State1.AddTask<FTestTask_PrintValue>(FName(TEXT("Tree1State1Task")));
				...
				{
					TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1State2Task = State2.AddTask<FTestTask_PrintValue>(FName(TEXT("Tree1State2Task")));
...
IMPLEMENT_METASTORY_INSTANT_TEST(FMetaStoryTest_WeakContext_FinishTask, "System.MetaStory.WeakContext.FinishTask");
...
struct FMetaStoryTest_WeakContext_InstanceData : FMetaStoryTestBase
{
	...
	virtual bool InstantTest() override
	{
		...
		#define UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC(T1) \
		...
		#define UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC_2(T1, T2) \
		...
		#define UE_METASTORY_TEST_CUSTOMTICKFUNC() \
			FMetaStoryTestLog& TestLog = Context.GetExternalData(Task->LogHandle);\
			TArray<int32> AllDatas = TestContext.ReadAllData();\
			TestLog.Log(Task->Name, FString::Printf(TEXT("AccessData:%s"), *TestContext.ReadAllData_ToString()));
		...
		// Tree2
		{
			...
			{
				TMetaStoryTypedEditorNode<FTestEval_Custom>& Tree2GlobalEval1 = EditorData.AddEvaluator<FTestEval_Custom>(FName("Tree2GlobalEval1"));
				...
				Tree2GlobalEval1.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestEval_Custom* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC_2(ContextTree2GlobalEvaluator1_1, ContextTree2GlobalEvaluator1_2);
					};
				Tree2GlobalEval1.GetNode().CustomTickFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestEval_Custom* Task)
					{
						UE_METASTORY_TEST_CUSTOMTICKFUNC();
					};
				Tree2GlobalEval1.GetNode().CustomExitStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestEval_Custom* Task)
					{
						UE_METASTORY_TEST_CUSTOMTICKFUNC();
					};
				TMetaStoryTypedEditorNode<FTestEval_Custom>& Tree2GlobalEval2 = EditorData.AddEvaluator<FTestEval_Custom>(FName("Tree2GlobalEval2"));
				...
				Tree2GlobalEval2.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestEval_Custom* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC_2(ContextTree2GlobalEvaluator2_1, ContextTree2GlobalEvaluator2_2);
					};
				...
				// Global Task
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree2GlobalTask1 = EditorData.AddGlobalTask<FTestTask_PrintValue>(FName("Tree2GlobalTask1"));
				...
				Tree2GlobalTask1.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestTask_PrintValue* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC_2(ContextTree2GlobalTask1_1, ContextTree2GlobalTask1_2);
					};
				...
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree2GlobalTask2 = EditorData.AddGlobalTask<FTestTask_PrintValue>(FName("Tree2GlobalTask2"));
				...
				Tree2GlobalTask2.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestTask_PrintValue* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC_2(ContextTree2GlobalTask2_1, ContextTree2GlobalTask2_2);
					};
			...
			{
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree2RootTask1 = Root.AddTask<FTestTask_PrintValue>(FName("Tree2RootTask1"));
				Tree2RootTask1.GetInstanceData().Value = 211;
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree2RootTask2 = Root.AddTask<FTestTask_PrintValue>(FName("Tree2RootTask2"));
				Tree2RootTask2.GetInstanceData().Value = 212;
			}
			// State 1
			UMetaStoryState& State1 = Root.AddChildState("Tree2State1");
			{
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree2State1Task1 = State1.AddTask<FTestTask_PrintValue>(FName("Tree2State1Task1"));
				...
				Tree2State1Task1.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestTask_PrintValue* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC_2(ContextTree2State1Task1_1, ContextTree2State1Task1_2);
				...
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree2State1Task2 = State1.AddTask<FTestTask_PrintValue>(FName("Tree2State1Task2"));
				...
				Tree2State1Task2.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestTask_PrintValue* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC_2(ContextTree2State1Task2_1, ContextTree2State1Task2_2);
					};
		...
		// Tree1
		{
			...
			{
				// Global Evaluator
				TMetaStoryTypedEditorNode<FTestEval_Custom>& Tree1GlobalEval1 = EditorData.AddEvaluator<FTestEval_Custom>(FName("Tree1GlobalEval1"));
				...
				Tree1GlobalEval1.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestEval_Custom* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC(ContextTree1GlobalEvaluator1);
					};
				...
				TMetaStoryTypedEditorNode<FTestEval_Custom>& Tree1GlobalEval2 = EditorData.AddEvaluator<FTestEval_Custom>(FName("Tree1GlobalEval2"));
				...
				Tree1GlobalEval2.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestEval_Custom* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC(ContextTree1GlobalEvaluator2);
					};
				...
				// Global Task
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1GlobalTask1 = EditorData.AddGlobalTask<FTestTask_PrintValue>(FName("Tree1GlobalTask1"));
				...
				Tree1GlobalTask1.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestTask_PrintValue* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC(ContextTree1GlobalTask1);
					};
				...
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1GlobalTask2 = EditorData.AddGlobalTask<FTestTask_PrintValue>(FName("Tree1GlobalTask2"));
				...
				Tree1GlobalTask2.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestTask_PrintValue* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC(ContextTree1GlobalTask2);
					};
			...
			{
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1RootTask1 = Root.AddTask<FTestTask_PrintValue>(FName("Tree1RootTask1"));
				Tree1RootTask1.GetInstanceData().Value = 111;
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1RootTask2 = Root.AddTask<FTestTask_PrintValue>(FName("Tree1RootTask2"));
			...
			{
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1State1Task1 = State1.AddTask<FTestTask_PrintValue>(FName("Tree1State1Task1"));
				...
				Tree1State1Task1.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestTask_PrintValue* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC(ContextTree1State1Task1);
					};
				...
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1State1Task2 = State1.AddTask<FTestTask_PrintValue>(FName("Tree1State1Task2"));
				...
				Tree1State1Task2.GetNode().CustomEnterStateFunc = [&TestContext](FMetaStoryExecutionContext& Context, const FTestTask_PrintValue* Task)
					{
						UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC(ContextTree1State1Task2);
					};
			...
			{
				TMetaStoryTypedEditorNode<FTestTask_PrintValue>& Tree1State5Task1 = State4.AddTask<FTestTask_PrintValue>(FName("Tree1State5Task1"));
		...
		#undef UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC
		#undef UE_METASTORY_TEST_CUSTOMENTERSTATEFUNC_2
		#undef UE_METASTORY_TEST_CUSTOMTICKFUNC
		...
		FMetaStoryInstanceData InstanceData;
		{
			...
			}
			{
				...
				FTestMetaStoryExecutionContext::FLogOrder ExpectedLog = Exec.Expect("Tree1GlobalEval1", TestContext.ExepectData(AllValidReadData, { 0 }));
			...
			}
			{
				...
				// Tick
				FTestMetaStoryExecutionContext::FLogOrder ExpectedLog = Exec.Expect("Tree2GlobalTask2", TEXT("Tick204"));
...
IMPLEMENT_METASTORY_INSTANT_TEST(FMetaStoryTest_WeakContext_InstanceData, "System.MetaStory.WeakContext.InstanceData");
} // namespace UE::MetaStory::Tests
