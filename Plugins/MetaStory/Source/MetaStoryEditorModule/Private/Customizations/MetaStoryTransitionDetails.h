...
/**
 * Type customization for FMetaStoryTransition.
 */

class FMetaStoryTransitionDetails : public IPropertyTypeCustomization
{
public:
...
private:
	...
	UMetaStoryEditorData* GetEditorData() const;

	FText GetDescription() const;

	EMetaStoryTransitionTrigger GetTrigger() const;
