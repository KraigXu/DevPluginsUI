...
{
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnMetaStoryPropertyBindingChanged, const FPropertyBindingPath& /*SourcePath*/, const FPropertyBindingPath& /*TargetPath*/);
	extern METASTORYEDITORMODULE_API FOnMetaStoryPropertyBindingChanged OnMetaStoryPropertyBindingChanged;
} // UE::MetaStory::PropertyBinding

class FMetaStoryBindingExtension : public FPropertyBindingExtension
{
private:
...
class FMetaStoryBindingsChildrenCustomization : public IDetailPropertyChildrenCustomizationHandler
{
public:
