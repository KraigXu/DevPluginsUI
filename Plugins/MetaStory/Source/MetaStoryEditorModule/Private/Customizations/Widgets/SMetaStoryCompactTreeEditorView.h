...
#include "SMetaStoryCompactTreeEditorView.generated.h"
...
{
	USTRUCT()
	struct FMetaStoryStateItemLinkData : public FMetaStoryStateItemCustomData
	{
		GENERATED_BODY()
...
public:
	...
	SLATE_BEGIN_ARGS(SCompactTreeEditorView)
		: _MetaStoryEditorData(nullptr)
		, _SelectionMode(ESelectionMode::Single)
		, _SelectableStatesOnly(false)
		, _SubtreesOnly(false)
		, _ShowLinkedStates(false)
	{}
		SLATE_ARGUMENT(const UMetaStoryEditorData*, MetaStoryEditorData)
