...
{
/**
 * @param StructProperty property pointing to a FMetaStoryEditorNode.
 * @return MetaStory editor node that is common for all edited instances.
 */
const FMetaStoryEditorNode* GetCommonNode(const TSharedPtr<IPropertyHandle>& StructProperty);

/**
 * @param StructProperty Property handle pointing to a FMetaStoryEditorNode.
 * @return mutable MetaStory editor node that is common for all edited instances.
 */
 ...
 * @param StructProperty Property handle of the MetaStoryEditorNode(s) 
 ...
 * @param ArrayPropertyHandle Property handle pointing to a TArray<FMetaStoryEditorNode>.
