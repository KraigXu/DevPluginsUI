...
/** Property Type Customization for FMetaStoryEditorColorRef */
class FMetaStoryEditorColorRefDetails : public IPropertyTypeCustomization
{
public:
...
private:
	UMetaStoryEditorData* GetEditorData(const TSharedRef<IPropertyHandle>& PropertyHandle) const;
};

/** Property Type Customization for FMetaStoryEditorColor */
class FMetaStoryEditorColorDetails : public IPropertyTypeCustomization
{
public:
	/** Makes a new instance of this detail layout class for a specific detail view requesting it */
	static TSharedRef<IPropertyTypeCustomization> MakeInstance();
