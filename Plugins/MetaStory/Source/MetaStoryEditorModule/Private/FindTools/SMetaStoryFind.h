...
class UMetaStory;
class IMetaStoryEditorHost;

namespace UE::MetaStoryEditor
{

/**
 * Widget to display and find inside a MetaStory asset.
 */
...
private:
	...
	public:
		...
		EResultType Type = EResultType::MetaStory;
	};
...
public:
	...
	void Construct(const FArguments& InArgs, TSharedPtr<IMetaStoryEditorHost> EditorHost);
