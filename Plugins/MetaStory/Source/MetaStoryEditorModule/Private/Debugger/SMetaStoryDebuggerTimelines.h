...
class SMetaStoryDebuggerTimelines : public SSimpleTimeSlider
{
	using FOnSelectionChanged = STreeView<TSharedPtr<RewindDebugger::FRewindDebuggerTrack>>::FOnSelectionChanged;
public:
	SLATE_BEGIN_ARGS(SMetaStoryDebuggerTimelines) {}
	...
	* Default constructor.
	*/
	SMetaStoryDebuggerTimelines();
	virtual ~SMetaStoryDebuggerTimelines();
