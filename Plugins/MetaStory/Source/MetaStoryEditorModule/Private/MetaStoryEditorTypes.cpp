...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MetaStoryEditorTypes)

bool FMetaStoryEditorColor::ExportTextItem(FString& OutValueString, const FMetaStoryEditorColor& DefaultValue, UObject* OwnerObject, int32 PortFlags, UObject* ExportRootScope) const
{
	...
	for (FProperty* Property : TFieldRange<FProperty>(FMetaStoryEditorColor::StaticStruct()))
	{
