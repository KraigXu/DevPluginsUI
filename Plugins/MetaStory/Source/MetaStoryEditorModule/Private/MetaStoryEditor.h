...
#include "IMetaStoryEditor.h"

class FMetaStoryEditorModeUILayer;
class FSpawnTabArgs;
class IMessageToken;
class UMetaStoryState;
class UMetaStoryNodeBlueprintBase;
...
class FMetaStoryEditor : public IMetaStoryEditor, public FSelfRegisteringEditorUndoClient, public FGCObject
{
...
public:
	...
	FMetaStoryEditor() : TreeViewCommandList(new FUICommandList()) {}

	virtual void RegisterTabSpawners(const TSharedRef<class FTabManager>& TabManager) override;
	virtual void UnregisterTabSpawners(const TSharedRef<class FTabManager>& TabManager) override;

	void InitEditor(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, UMetaStory* MetaStory);
...
private:
	...
	/** Tree View */
	TSharedPtr<class SMetaStoryView> MetaStoryView;

	/** Tree Outliner */
	TSharedPtr<class SMetaStoryOutliner> MetaStoryOutliner;
