...
SMetaStoryExpanderArrow::SMetaStoryExpanderArrow()
{
}

void SMetaStoryExpanderArrow::Construct( const FArguments& InArgs, const TSharedPtr<class ITableRow>& TableRow  )
{
	...
	[
		...
		.Visibility(this, &SMetaStoryExpanderArrow::GetExpanderVisibility)
		.ClickMethod(EButtonClickMethod::MouseDown )
		.OnClicked(this, &SMetaStoryExpanderArrow::OnArrowClicked)
		.ForegroundColor(FLinearColor(1,1,1,0.75f))
		.IsFocusable(false)
		.ContentPadding(TAttribute<FMargin>( this, &SMetaStoryExpanderArrow::GetExpanderPadding )) //FMargin(0))
		.HAlign(HAlign_Left)
		.VAlign(VAlign_Top)
		[
			SNew(SImage)
			.DesiredSizeOverride(FVector2D(InArgs._ImageSize))
			.Image(this, &SMetaStoryExpanderArrow::GetExpanderImage)
			.ColorAndOpacity(FLinearColor(1,1,1,0.5f))
		]
	];
}

int32 SMetaStoryExpanderArrow::OnPaint(const FPaintArgs& Args, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled) const
{
...
FReply SMetaStoryExpanderArrow::OnArrowClicked()
{
...
EVisibility SMetaStoryExpanderArrow::GetExpanderVisibility() const
{
...
const FSlateBrush* SMetaStoryExpanderArrow::GetExpanderImage() const
{
...
FMargin SMetaStoryExpanderArrow::GetExpanderPadding() const
{
