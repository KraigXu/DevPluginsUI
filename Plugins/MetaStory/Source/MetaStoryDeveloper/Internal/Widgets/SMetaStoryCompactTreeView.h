...
#include "SMetaStoryCompactTreeView.generated.h"
 ...
 */
USTRUCT()
struct FMetaStoryStateItemCustomData
{
	GENERATED_BODY()
};
}
...
protected:
	...
	struct FStateItem : TSharedFromThis<FStateItem>
	{
		...
		TInstancedStruct<UE::MetaStory::CompactTreeView::FMetaStoryStateItemCustomData> CustomData;
