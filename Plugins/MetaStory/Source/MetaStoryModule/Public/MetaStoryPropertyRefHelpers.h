...
struct FMetaStoryPropertyPathIndirection;
...
{
#if WITH_EDITOR
	METASTORYMODULE_API extern const FName IsRefToArrayName;
	METASTORYMODULE_API extern const FName CanRefToArrayName;
	METASTORYMODULE_API extern const FName RefTypeName;
	/**
	 ...
	 */
	bool METASTORYMODULE_API IsPropertyRefCompatibleWithProperty(const FProperty& RefProperty, const FProperty& SourceProperty, const void* PropertyRefAddress, const void* SourceAddress);
	 ...
	 */
	bool METASTORYMODULE_API IsPropertyAccessibleForPropertyRef(TConstArrayView<FPropertyBindingPathIndirection> SourcePropertyPathIndirections, FMetaStoryBindableStructDesc SourceStruct);

	UE_DEPRECATED(5.6, "Use the overload taking FPropertyBindingPathIndirection instead")
	bool METASTORYMODULE_API IsPropertyAccessibleForPropertyRef(TConstArrayView<FMetaStoryPropertyPathIndirection> SourcePropertyPathIndirections, FMetaStoryBindableStructDesc SourceStruct);
	 ...
	 * @return true if property can be referenced by PropertyRef.
	 */
	bool METASTORYMODULE_API IsPropertyAccessibleForPropertyRef(const FProperty& SourceProperty, TConstArrayView<FBindingChainElement> BindingChain, FMetaStoryBindableStructDesc SourceStruct);
	 ...
	 */
	TArray<FEdGraphPinType, TInlineAllocator<1>> METASTORYMODULE_API GetPropertyRefInternalTypesAsPins(const FProperty& RefProperty);
	 ...
	 */
	FEdGraphPinType METASTORYMODULE_API GetPropertyRefInternalTypeAsPin(const FProperty& RefProperty, const void* PropertyRefAddress);

	/**
	 * @param InPropertyRef PropertyRef to get internal type from.
	 * @return PinType for Blueprint PropertyRef's internal type
	 */
	FEdGraphPinType METASTORYMODULE_API GetBlueprintPropertyRefInternalTypeAsPin(const FMetaStoryBlueprintPropertyRef& InPropertyRef);
	 ...
	 */
	bool METASTORYMODULE_API IsPropertyRef(const FProperty& Property);
	 ...
	 */
	bool METASTORYMODULE_API IsBlueprintPropertyRefCompatibleWithProperty(const FProperty& SourceProperty, const void* PropertyRefAddress);
	...
	bool METASTORYMODULE_API IsPropertyCompatibleWithStruct(const FProperty& Property, const class UScriptStruct& Struct);
	...
	bool METASTORYMODULE_API IsPropertyCompatibleWithClass(const FProperty& Property, const class UClass& Class);
	...
	bool METASTORYMODULE_API IsPropertyCompatibleWithEnum(const FProperty& Property, const class UEnum& Enum);
