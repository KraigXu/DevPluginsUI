...
*/
class IMetaStoryModule : public IModuleInterface
{
...
public:
	...
	*/
	static IMetaStoryModule& Get()
	{
		return FModuleManager::LoadModuleChecked<IMetaStoryModule>("MetaStoryModule");
	}
	...
	*/
	...
	{
		return FModuleManager::Get().IsModuleLoaded("MetaStoryModule");
	}
	 ...
	 * @note Even if it returns false this can still have enabled MetaStory related channels, OutTraceId will indicate
