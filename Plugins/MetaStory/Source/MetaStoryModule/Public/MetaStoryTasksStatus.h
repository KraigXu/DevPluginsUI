...
#include "MetaStoryTasksStatus.generated.h"
...
UENUM()
enum class EMetaStoryTaskCompletionType : uint8
{
...
namespace UE::MetaStory
{
	...
	public:
		TTasksCompletionStatus(TNotNull<T*> InFirstCompletionBits, TNotNull<T*> InSecondCompletionBits, T InCompletionMask, int32 InBitIndex, EMetaStoryTaskCompletionType InTaskControl)
	...
	public:
		...
		[[nodiscard]] ETaskCompletionStatus GetCompletionStatus() const
		{
			...
			if (TaskControl == EMetaStoryTaskCompletionType::All)
			{
		...
		{
			return TaskControl == EMetaStoryTaskCompletionType::All ? HasAllCompleted() : HasAnyCompleted();
		}
	...
	private:
		...
		EMetaStoryTaskCompletionType TaskControl;
	};
 ...
 */
USTRUCT()
struct FMetaStoryTasksCompletionStatus
{
	GENERATED_BODY()
...
public:
	FMetaStoryTasksCompletionStatus() = default;
	METASTORYMODULE_API explicit FMetaStoryTasksCompletionStatus(const FMetaStoryCompactFrame& Frame);
	METASTORYMODULE_API ~FMetaStoryTasksCompletionStatus();

	METASTORYMODULE_API FMetaStoryTasksCompletionStatus(const FMetaStoryTasksCompletionStatus&);
	METASTORYMODULE_API FMetaStoryTasksCompletionStatus(FMetaStoryTasksCompletionStatus&&);
	METASTORYMODULE_API FMetaStoryTasksCompletionStatus& operator=(const FMetaStoryTasksCompletionStatus&);
	METASTORYMODULE_API FMetaStoryTasksCompletionStatus& operator=(FMetaStoryTasksCompletionStatus&&);

public:
	[[nodiscard]] METASTORYMODULE_API UE::MetaStory::FTasksCompletionStatus GetStatus(const FMetaStoryCompactState& State);
	[[nodiscard]] METASTORYMODULE_API UE::MetaStory::FConstTasksCompletionStatus GetStatus(const FMetaStoryCompactState& State) const;

	[[nodiscard]] METASTORYMODULE_API UE::MetaStory::FTasksCompletionStatus GetStatus(TNotNull<const UMetaStory*> MetaStory);
	[[nodiscard]] METASTORYMODULE_API UE::MetaStory::FConstTasksCompletionStatus GetStatus(TNotNull<const UMetaStory*> MetaStory) const;
	...
	METASTORYMODULE_API void Push(const FMetaStoryCompactState& State);

	METASTORYMODULE_API bool Serialize(FArchive& Ar);
	METASTORYMODULE_API bool NetSerialize(FArchive& Ar, UPackageMap* Map, bool& bOutSuccess);
...
private:
	...
	void CopyBuffer(const FMetaStoryTasksCompletionStatus& Other);

	template<typename TTasksCompletionStatusType>
	inline TTasksCompletionStatusType GetStatusInternal(FMaskType Mask, uint8 BufferIndex, uint8 BitsOffset, EMetaStoryTaskCompletionType Control);
...
template<>
struct TStructOpsTypeTraits<FMetaStoryTasksCompletionStatus> : public TStructOpsTypeTraitsBase2<FMetaStoryTasksCompletionStatus>
{
	enum
	{
		WithCopy = true,
