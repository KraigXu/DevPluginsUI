...
/**
 * Edit time data for MetaplotFlow asset. This data gets baked into runtime format before being used by the StateTreeInstance.
 */
UCLASS(MinimalAPI, BlueprintType, EditInlineNew, CollapseCategories, Within = "StateTree", meta = (DisallowLevelActorReference = true))
class UMetaplotFlowEditorData : public UObject, public IStateTreeEditorPropertyBindingsOwner
{
	GENERATED_BODY()
